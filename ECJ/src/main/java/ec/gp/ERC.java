...
public abstract class ERC extends GPNode
    ...
    /** You might want to override this to return a special human-readable version of the erc value; otherwise this defaults to toString();  
     * This should be something that resembles a LISP atom.  
     * If a simple number or other object won't suffice, you might use something that begins with  name() + [ + ... + ] */
