// Copy of KozaFitnecc.java in ec.gp.koza without fitness() being normalization
...
import static ec.gp.koza.GPKozaDefaults.P_KOZA;
import java.io.*;
...
public class CustomFitness extends Fitness
    ...
    */
    ...
    public double fitness()
        ...
        return standardizedFitness; // changed
        }
    ...
    */
    ...
    public boolean equivalentTo(final Fitness _fitness)
        ...
        return ((CustomFitness)_fitness).standardizedFitness() == standardizedFitness;
        }
    ...
    public void setToMeanOf(EvolutionState state, Fitness[] fitnesses)
        ...
        for(int i = 0; i < fitnesses.length; i++)
            {
            CustomFitness fit = (CustomFitness)(fitnesses[i]);
